...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7cffb02e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueMapbox.vue?vue&type=template&id=6c53a316&
...
// CONCATENATED MODULE: ./src/components/VueMapbox.vue?vue&type=template&id=6c53a316&
...
var dist_mapbox_gl = __webpack_require__("ac6d");
...
mapbox_gl_default.a.prewarm(); // import { ScatterplotLayer, ArcLayer, HexagonLayer } from '@deck.gl/layers'
...
/* harmony default export */ var VueMapboxvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this.layers = new Map();
    this.images = new Map(); // make sure the html div to use in mapbox is loaded
  ...
  methods: {
    createMap: function createMap() {
      ...
      if (this.accessToken !== '') {
        mapbox_gl_default.a.accessToken = this.accessToken;
      } else if (true) {
        mapbox_gl_default.a.accessToken = "pk.eyJ1IjoibGVjZWxlcyIsImEiOiJjajUyZXBzbXEwZjYxMnFwOWFxeHd5ZDY3In0.dftZ4LdgXBkdZI0_l7pcNA";
      }

      this.map = new mapbox_gl_default.a.Map(Object(objectSpread2["a" /* default */])({}, this.otherOptions, {
        container: this.$refs.mapabaselayer,
        refreshExpiredTiles: false,
        antialias: true,
        style: this.mapStyle,
        center: this.center,
        zoom: this.zoom // maxBounds: [ -48.44732177294034, -16.638275455496753, -47.22472784587998, -14.904304916348181 ]
      ...
      this.map.on('load', function () {
        ...
        _this3.$emit('load', _this, _this3.map);
    ...
    */
    setupEvents: function setupEvents(listners, MapboxElement, theEventsOfElement, VueInstance) {
      if (listners) {
    ...
    * Create/Update Layer
    */
    addLayer: function addLayer(id, type, options) {
      // // if layer name exist, create a randow one
      if (this.layers.get(id)) {
        id = uniqueId_default()(id + type);
      }

      this.map.addLayer(Object(objectSpread2["a" /* default */])({
        id: id,
        type: type
      }, options));
      var sourceObject = this.map.getLayer(id);
      this.layers.set(id, {
        id: id,
        type: type,
        options: options,
...
/* harmony default export */ var VueMapbox = __webpack_exports__["default"] = (component.exports);

/***/ })

}]);
//# sourceMappingURL=vue-mapbox.common.2.js.map