...
/******/ 		return __webpack_require__.p + "vue-mapbox.common." + ({"0":"the-decker","1":"the-vue-mapbox","2":"vendors~mapboxgl-core","3":"vendors~the-decker","4":"vendors~the-vue-mapbox"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/ 				var href = "css/" + ({"0":"the-decker","1":"the-vue-mapbox","2":"vendors~mapboxgl-core","3":"vendors~the-decker","4":"vendors~the-vue-mapbox"}[chunkId]||chunkId) + "." + {"0":"31d6cfe0","1":"e9d9738c","2":"31d6cfe0","3":"31d6cfe0","4":"e6bc587c"}[chunkId] + ".css";
...
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("9b02");
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var lodash_has__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("3852");
...
/* harmony default export */ __webpack_exports__["a"] = (function (Node, componentNameToFind) {
  ...
  var findLayers = function findLayers(VNode, bag) {
    ...
    if (lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNode, 'componentInstance')) {
      VNodeInstance = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNode, 'componentInstance');
    } else {
      VNodeInstance = VNode;
    }

    if (lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNodeInstance, '$options.name', lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNodeInstance, 'componentOptions.Ctor.options.name')) === componentNameToFind) {
      bag.push(VNodeInstance);
      console.log(lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNodeInstance, '$props.name'));
    ...
    var children = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNodeInstance, '$children') || lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(VNodeInstance, 'children');
    ...
    if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(VNodeInstance, '$slots')) {
    ...
    if (lodash_has__WEBPACK_IMPORTED_MODULE_4___default()(VNodeInstance, '$scopedSlots')) {
...
//
//
var nativeEventsTypes = ['open', 'close'];
...
/* harmony default export */ var VmPopup = (component.exports);
...
/* harmony default export */ var VmMarkervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getPopupClick: function getPopupClick() {
      var popupFind = Object(findVNodeChildren["a" /* default */])(this.$slots.default, 'VmPopup');
  ...
  render: function render(h) {
    ...
    if (popup) {
      ...
      var popupFind = Object(findVNodeChildren["a" /* default */])(popup, 'VmPopup');
      ...
      popupInstance.componentOptions.propsData = Object(objectSpread2["a" /* default */])({}, popupProps, {}, popupInstance.componentOptions.propsData); // if close popup, updade opemn props
...
var VmMarker_component = Object(componentNormalizer["a" /* default */])(
...
/* harmony default export */ var VmLayervue_type_script_lang_js_ = ({
  ...
  watch: {
    source: function source(val) {
      if (Object(esm_typeof["a" /* default */])(val) === 'object') {
        ...
        this.MapboxVueInstance.updateSource(source, val.type, Object(objectSpread2["a" /* default */])({}, val));
      }
    },
  ...
  methods: {
    ...
    addLayer: function addLayer() {
      try {
        if (this.customLayer) {
          ...
          var _mylayer = this.MapboxVueInstance.addLayer(Object(objectSpread2["a" /* default */])({}, this.options, {
            id: id,
            type: this.type,
            paint: this.myPaint,
    ...
    */
    getFinalFeatureStateForPaintOrLayout: function getFinalFeatureStateForPaintOrLayout(normal, hover, click) {
      var result = Object(objectSpread2["a" /* default */])({}, normal);
  ...
  render: function render(h) {
    ...
    popupInstance.componentOptions.propsData = Object(objectSpread2["a" /* default */])({}, popupInstance.componentOptions.propsData, {}, props);
...
var VmLayer_component = Object(componentNormalizer["a" /* default */])(
  ...
  watch: {
    '$props.options': function $propsOptions(val, oldval) {
      if (this.type === 'geojson' && val && val.data) {
        ...
        this.source = this.MapboxVueInstance.updateSource(this.source.id, this.type, Object(objectSpread2["a" /* default */])({}, val));
      }
    }
  },
  created: function created() {
    var options = Object(objectSpread2["a" /* default */])({}, this.$props.options);
...
var VmSource_component = Object(componentNormalizer["a" /* default */])(
...
var VmImage_component = Object(componentNormalizer["a" /* default */])(
...
var VmLayerVector_component = Object(componentNormalizer["a" /* default */])(
...
/* harmony default export */ var VmMarkerDonutvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    return h(VmMarker, {
      props: Object(objectSpread2["a" /* default */])({}, this.$attrs, {}, this.$props, {
        anchor: 'center'
      }),
...
var VmMarkerDonut_component = Object(componentNormalizer["a" /* default */])(
...
var LoadingComponent_component = Object(componentNormalizer["a" /* default */])(
  script,
...
var ErrorComponent_component = Object(componentNormalizer["a" /* default */])(
...
/* harmony default export */ var library_entry = ({
  VueMapbox: function VueMapbox() {
    return {
      // O componente a carregar (deve ser uma Promise)
      component: Promise.all(/* import() | the-vue-mapbox */[__webpack_require__.e(4), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, "ccd4")),
  ...
  VmPopup: VmPopup,
  VmLayer: VmLayer,
  VmLayerArc: function VmLayerArc() {
    return {
      // O componente a carregar (deve ser uma Promise)
      component: Promise.all(/* import() | the-decker */[__webpack_require__.e(3), __webpack_require__.e(0)]).then(__webpack_require__.bind(null, "ed81")),
      // Um componente para usar enquanto o assíncrono é carregado
      loading: LoadingComponent,
      // Um componente para usar se o carregamento falhar
      error: ErrorComponent,
